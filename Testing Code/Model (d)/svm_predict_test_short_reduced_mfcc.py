...
if __name__ == "__main__":
    model_path = 'Dataset/svm_model_best_reduced_mfcc.joblib'
    scaler_path = 'Dataset/scaler_best_reduced_mfcc.joblib'
    encoder_path = 'Dataset/label_encoder_best_reduced_mfcc.joblib'
    features_path = 'Dataset/Processed(3)/test_features.npy'
    output_file = 'Dataset/svm_submission_short_reduced_mfcc.csv'
